    ...
    <div class="app-sidebar__overlay" data-toggle="sidebar"></div>
     <aside class="app-sidebar">
      ...
      <ul class="app-menu">
        ...
        <li><a class="app-menu__item active " href="viewchat.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">View user Health details</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        ...
        <ul class="app-breadcrumb breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="">SEND RESPONSE FOR USER</a></li>
        </ul>
      </div>
...
$query="SELECT * from userprofile,chat where userprofile.email in(select user_id from chat where sender_id='$a')"; 
          ...
          <button class="close" type="button" data-dismiss="alert">×</button>
            <div class="table-responsive">
              <table class="table">
                ...
                <tbody>
				 <h3 class="tile-title"><?php echo $data['message']; ?> </h3>
				
				 <label class="col-form-label col-form-label-lg" for="inputLarge"> <?php echo $data['firstname']; ?><?php echo $data['seccondname']; ?></label>
