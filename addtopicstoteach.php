  ...
  <body class="app sidebar-mini" onLoad="initGeolocation();">
    ...
    <aside class="app-sidebar">
      <div class="app-sidebar__user">
       ...
       <ul class="app-menu">
        <li><a class="app-menu__item" href="cdashboard.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">DASHBOARD</span></a></li>
		
        <li><a class="app-menu__item" href="addtopicstoteach.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">ADD TOPIC TO TEACHER</span></a></li>
            
        <li><a class="app-menu__item" href="viewteachtopics.php"><i class="app-menu__icon fa fa-dashboard"></i><span class="app-menu__label">VIEW TEACHER DETAILS</span></a></li>
    ...
    <main class="app-content">
      <div class="app-title">
        <div> 
        <h1><i class="fa fa-file-text-o"></i>ADD TOPIC TO TEACHER</h1>
